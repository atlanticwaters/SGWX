...
function ScaleIcon() {
  return (
    ...
    >
      ...
      />
      <path fill="#0a1f18" d="m4.5 17 -4 -2.5h8l-4 2.5Z" />
      <path fill="#0a1f18" d="m18.5 13 -4 -2.5h8l-4 2.5Z" />
      <path fill="#0a1f18" d="M11.5 5.5 10 4 11.5 0.5 13 4l-1.5 1.5Z" />
      <path fill="#e6ffbb" d="M7.3 22 7 23.5h9l-0.2 -1.5H7.3Z" />
      <path
        stroke="#55850d"
        strokeLinecap="round"
