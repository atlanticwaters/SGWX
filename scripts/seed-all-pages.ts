...
const processPage = {
  ...
  stages: [
    {
      ...
      services: [
        { _key: "sv1a", _type: "string", value: "brand architecture" },
        { _key: "sv1b", _type: "string", value: "visual identity systems" },
        { _key: "sv1c", _type: "string", value: "positioning strategy" },
        { _key: "sv1d", _type: "string", value: "marketing roadmaps" },
        { _key: "sv1e", _type: "string", value: "messaging" },
        { _key: "sv1f", _type: "string", value: "MVPs" },
      ],
      proof: {
    ...
    },
    {
      ...
      services: [
        { _key: "sv2a", _type: "string", value: "campaigns" },
        { _key: "sv2b", _type: "string", value: "content" },
        { _key: "sv2c", _type: "string", value: "games" },
        { _key: "sv2d", _type: "string", value: "experiences" },
        { _key: "sv2e", _type: "string", value: "activations" },
        { _key: "sv2f", _type: "string", value: "engagement" },
      ],
      proof: {
    ...
    },
    {
      ...
      services: [
        { _key: "sv3a", _type: "string", value: "community growth" },
        { _key: "sv3b", _type: "string", value: "membership + loyalty" },
        { _key: "sv3c", _type: "string", value: "ambassadors" },
        { _key: "sv3d", _type: "string", value: "influencers + KOLs" },
        { _key: "sv3e", _type: "string", value: "creator partnerships" },
        { _key: "sv3f", _type: "string", value: "amplification" },
      ],
      proof: {
    ...
    },
    {
      ...
      services: [
        { _key: "sv4a", _type: "string", value: "transformation strategy" },
        { _key: "sv4b", _type: "string", value: "organizational alignment" },
        { _key: "sv4c", _type: "string", value: "cross-cultural adoption" },
        { _key: "sv4d", _type: "string", value: "engagement initiatives" },
        { _key: "sv4e", _type: "string", value: "celebratory moments" },
        { _key: "sv4f", _type: "string", value: "generative AI + automation" },
      ],
      proof: {
  ...
  fitGoodItems: [
    { _key: "pfg1", _type: "string", value: "You need senior expertise without long-term overhead" },
    { _key: "pfg2", _type: "string", value: "You value speed, clarity, and follow-through" },
    { _key: "pfg3", _type: "string", value: "You want teams who integrate, not perform" },
  ],
  fitNotItems: [
    {
      _key: "pfn1",
  ...
  // Closing
  closingStageWords: [
    { _key: "cw1", text: "launch", color: "text-sgwx-green" },
    { _key: "cw2", text: "engage", color: "text-sgwx-cyan" },
    { _key: "cw3", text: "mobilize", color: "text-sgwx-green" },
    { _key: "cw4", text: "transform", color: "text-sgwx-cyan" },
  ],
  closingWordmark: "SAGEWORX",
  closingTagline: "Emerge. Engage. Evolve.",
  closingCta: cta("Activate Your Team", "/contact"),
